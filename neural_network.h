...
typedef struct weight_struct_t {
    ...
    double v; // velocity to apply momentum
    double p; // AdaGrad: sum of squares of gradients
    double adam_m; // Adam: first moment estimate
    double adam_v; // Adam: second moment estimate
} weight_struct_t;
