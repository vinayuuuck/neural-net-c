...
void inline evaluate_dh_dW_Lh_Lprev(unsigned int n_h, unsigned int n_prev, n_ReLu neur[n_prev], unsigned int n_W, double J[][n_W]);
...
void inline evaluate_dh_dW_Lh_Lprev_sparse(unsigned int n_h, unsigned int n_prev, n_ReLu neur[n_prev], unsigned int n_W, double J[][n_W]);
...
void initialise_weight_matrices(void){
    ...
    for (int i=0; i < N_NEURONS_LI; i++){
        for (int j=0; j <N_NEURONS_L1; j++){
            ...
            w_LI_L1[i][j].v = 0.0;
            w_LI_L1[i][j].p = 0.0;
            w_LI_L1[i][j].adam_m = 0.0;
            w_LI_L1[i][j].adam_v = 0.0;
        }
    }
    ...
    for (int i=0; i < N_NEURONS_L1; i++){
        for (int j=0; j <N_NEURONS_L2; j++){
            ...
            w_L1_L2[i][j].v = 0.0;
            w_L1_L2[i][j].p = 0.0;
            w_L1_L2[i][j].adam_m = 0.0;
            w_L1_L2[i][j].adam_v = 0.0;
        }
    }
    ...
    for (int i=0; i < N_NEURONS_L2; i++){
        for (int j=0; j <N_NEURONS_L3; j++){
            ...
            w_L2_L3[i][j].v = 0.0;
            w_L2_L3[i][j].p = 0.0;
            w_L2_L3[i][j].adam_m = 0.0;
            w_L2_L3[i][j].adam_v = 0.0;
        }
    }
    ...
    for (int i=0; i < N_NEURONS_L3; i++){
        for (int j=0; j <N_NEURONS_LO; j++){
            ...
            w_L3_LO[i][j].v = 0.0;
            w_L3_LO[i][j].p = 0.0;
            w_L3_LO[i][j].adam_m = 0.0;
            w_L3_LO[i][j].adam_v = 0.0;
        }
    }
}
